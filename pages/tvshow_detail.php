...
if (isset($movieName)) {
    ...
    $apiUrl = "https://api.themoviedb.org/3/search/tv?api_key={$apiKey}&query={$encodedMovieName}";
    ...
    if (isset($data['results'][0])) {
        ...
        $releaseDate = $movie['release_date'];
         ...
         $creditsApiUrl = "https://api.themoviedb.org/3/tv/{$movie['id']}/credits?api_key={$apiKey}";
        ...
        $similarMoviesApiUrl = "https://api.themoviedb.org/3/tv/{$movie['id']}/similar?api_key={$apiKey}";
        ...
        $genresApiUrl = "https://api.themoviedb.org/3/genre/tv/list?api_key={$apiKey}";
        ...
        $movieId = $movie['id'];
        $trailersApiUrl = "https://api.themoviedb.org/3/tv/{$movieId}/videos?api_key={$apiKey}";
...
$watchProvidersApiUrl = "https://api.themoviedb.org/3/tv/{$movie['id']}/watch/providers?api_key={$apiKey}";
...
if (isset($watchProvidersData['results'])) {
    ...
    foreach ($results as $country) {
        ...
        $imagesApiUrl = "https://api.themoviedb.org/3/tv/{$movieId}/images?api_key={$apiKey}";
